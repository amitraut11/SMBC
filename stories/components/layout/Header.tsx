// stories/components/layout/Header.tsx
      ...
      <div className="container flex">
        <div className="flex items-center">
          <button
            ...
            style={{ color: textColor }} // Apply text color here
          >
            <svg
          ...
          {dropdownOpen && (
            <div
              className="absolute bg-white text-blue-600 shadow-lg mt-2 ml-16 rounded-md z-10"
        ...
        <h1 className="text-xl font-bold" style={{ color: textColor }}>XYZ BANK</h1>
